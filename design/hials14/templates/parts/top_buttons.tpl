<ul class="nav nav-pills hials-btn pull-right">
    ...
    <li id="btnSearch" class="hidden-xs"><a class="collapsed" data-toggle="collapse" href="#searchMenu" aria-expanded="false" aria-controls="searchMenu"><i class="fa fa-search"></i></a></li>
