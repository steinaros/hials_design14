...
{/if}
{set-block scope=root variable=email_sender}{if $collection.attributes[1].has_content}{$collection.attributes[1].content}{else}NO-REPLY-www@hials.no{/set-block}
{*
