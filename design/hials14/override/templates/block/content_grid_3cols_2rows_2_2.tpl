...
<div class="block-type-content-grid block-view-{$block.view}">
	<div class="container-sm-height hv-borderspacing">
	    ...
	    <div class="row-sm-height">
            ...
            {node_view_gui view='block_item_simple' content_node=$valid_nodes[3] css_class="col-sm-3 col-sm-height col-middle text-center bg-darkgray h3 block_item_simple"}
	    </div>
	</div>
</div>
