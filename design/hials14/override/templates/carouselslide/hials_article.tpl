...
<!-- {$content_node|attribute('show', 2, 'text')} -->
<div class="item">{attribute_view_gui attribute=$content_node.data_map.image image_class=$big_class css_class='img-responsive'}
