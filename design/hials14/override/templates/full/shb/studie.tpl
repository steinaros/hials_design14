...
{include uri='design:shb/parts/shb_box.tpl'}
            ...
            <div style="margin-bottom:15px;">
	            ...
	            <a class="btn btn-hials btn-lg btn-block" href="{concat('/layout/set/pdf/content/view/complete/', $node.node_id, '/language/', $language_code)|ezurl(no)}" role="button no-follow"><i class="fa fa-file-pdf-o"></i><span>{'PDF version'|i18n('hials/design/shb')}</span></a>
            </div>
