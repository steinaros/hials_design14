<div class="content-view-embed">
    ...
    <dl>
        ...
        {if or($child.data_map.sakliste.has_content, $child.data_map.sakliste.has_content)}
            ...
            {if $file.has_content}
                <li><div class="attribute-{$file.content.mime_type_part}"><a href={concat("content/download/", $file.contentobject_id, "/", $file.id, "/file/", $file.content.original_filename)|ezurl} title="{concat('Agenda'|i18n('design/hials/meeting'),' ',$child.data_map.type.content|wash|downcase,' ',$child.data_map.dato.content.timestamp|l10n('date'))}">{'Agenda'|i18n('design/hials/meeting')} ({$file.content.filesize|si(byte)})</a></li>
            {/if}
            {undef $file}
